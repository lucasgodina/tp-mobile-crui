    ...
    <div class="container">
        ...
        <form action="{{ route('equipos.update', ['equipo' => $equipo->id]) }}" method="POST" class="col-4 p-4 m-auto">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" id="email" value="{{ $equipo->email }}" class="form-control">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="checkbox" name="activo" id="activo" value="{{ $equipo->activo }}" class="form-check-input">
            </div>
            <div class="mb-3">
                <label for="victorias" class="form-label">Victorias</label>
                <input type="number" name="victorias" id="victorias" value="{{ $equipo->victorias }}" class="form-control">
            </div>
            <div class="mb-3">
